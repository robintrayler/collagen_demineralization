...
In all cases, untreated samples (time-0) had C:N~atomic~ values higher than 3.6, indicating the contribution of carbonate-bound carbon. Most acid treated samples had C:N~atomic~ within the broadest acceptable range for well preserved collagen (2.9--3.6) [@ambrose1990; @deniro1985], although not all samples fell within the more conservative ranges proposed by Guiry and Szpak[@guiry2020] and Van Klinken et al.[@vanklinken1999]. C:N~atomic~ values for both *Odocoileus* and *Prionace* samples were systematically higher than 3.30. Given that we did not attempt to remove lipids from our collagen samples prior to analysis, we attribute these slightly higher C:N~atomic~ values to residual lipids.  

Taken together, both yield and and quality data are indicative of well preserved  collagen. This is to be expected as our experiments were conducted using well preserved modern specimens. However, establishing the fidelity of our extracted collagen is key for interpreting our infrared spectroscopy and stable isotope results. <!-- I need something else here to finish off this paragraph. --> 
